...
NZB Monkey Go also includes the functionality of the [NZBSeracher](https://github.com/Tensai75/nzbsearcher) so besides in the nzb search engines it can also search directly on the news server and create the NZB file from the article headers.
...
![Monkey-Gif](https://raw.githubusercontent.com/Tensai75/nzb-monkey-go/master/resources/nzbmonkey-go.gif)
